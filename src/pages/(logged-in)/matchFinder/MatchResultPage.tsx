  ...
  const handleSubmitResult = async () => {
    ...
    try {
      const userConfirmed = confirm(
        "Er du sikker på, at du vil indsende dette resultat?"
      );
      if (userConfirmed) {
        ...
        <div className="flex flex-col gap-4 mx-4 my-10 text-sm">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="grid grid-cols-2 border p-4 rounded-md border-blue-500 gap-6">
              ...
              >
                ...
                {getAvailablePlayers([player2, player3, player4]).map(
                  (player) => (
              ...
              >
                ...
                {getAvailablePlayers([player1, player3, player4]).map(
                  (player) => (
                    <option key={player} value={player}>
                      {player}
                    </option>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="grid grid-cols-2 border p-4 rounded-md border-red-500 gap-6">
              ...
              >
                ...
                {getAvailablePlayers([player1, player2, player4]).map(
                  (player) => (
                    <option key={player} value={player}>
                      {player}
                    </option>
              ...
              >
                ...
                {getAvailablePlayers([player1, player2, player3]).map(
                  (player) => (
                    <option key={player} value={player}>
                      {player}
                    </option>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex gap-2 items-center">
                <input
                  ...
                  checked={detailedScore}
                  onChange={(e) => setDetailedScore(e.target.checked)}
                />
              ...
              {[...Array(totalSets)].map((_, index) => (
                <div key={index} className="grid grid-cols-2 gap-2">
                  <select
                    ...
                    onChange={(e) =>
                      handleScoreChange(index, "team1", Number(e.target.value))
                    }
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleScoreChange(index, "team2", Number(e.target.value))
                    }
                    className="rounded-md border-gray-300 shadow-sm focus:border-cyan-500 focus:ring-cyan-500 sm:text-sm text-black"
                  >
                    {[0, 1, 2, 3, 4, 5, 6, 7].map((n) => (
          ...
          {totalSets > 0 && (
            <button
              ...
              className="w-full bg-slate-700/80 text-cyan-500 p-2 px-4 rounded-lg mt-4"
            >
              Indsend resultat
            </button>
          )}
