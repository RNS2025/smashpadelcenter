    ...
    return (
        <div className="w-full bg-white rounded-xl p-4 text-gray-900 mt-10">
            <form className="space-y-10">
                ...
                <div>
                    <label className="font-semibold" htmlFor="center">Vælg center</label>
                    <select className="w-full rounded-lg border-gray-900 h-12 pr-1 text-sm" id="center"
                    >
                ...
                <div className="flex flex-col">
                    <label className="font-semibold" htmlFor="tidspunkt">Dato og tidspunkt</label>
                    <DatePicker
                ...
                <div>
                    <label className="font-semibold" htmlFor="reserverede">Reserverede pladser</label>
                            ...
                            {availableSpotsArray.map((spot) => (
                                <button
                                    ...
                                    className={`p-2 w-full rounded-xl transition duration-300 ${
                                        selectedReserved === spot ? "bg-cyan-500 text-white hover:bg-cyan-600 transition duration-300" : "bg-gray-300 hover:bg-gray-400 transition duration-300"
                                    }`}
                                >
                                    {spot}
                                </button>
                ...
                <div>
                    <label className="font-semibold" htmlFor="reserverede">Bane er booket</label>
                    <div className="flex h-12">
                        <div className="flex items-center w-full rounded-lg gap-6 pr-1">
                            {courtBookedArray.map(({ label, value }) => (
                                <button
                                    ...
                                    className={`p-2 w-full rounded-xl transition duration-300 ${
                                        courtBooked === value ? "bg-cyan-500 hover:bg-cyan-600 transition duration-300 text-white" : "bg-gray-300 hover:bg-gray-400 transition duration-300"
                                    }`}
                                >
                                    {label}
                                </button>
                ...
                <div className="grid grid-cols-4 gap-4">
                    ...
                    <div>
                        <label className="font-semibold" htmlFor="spilletid">Spilletid</label>
                        <div className="flex h-12">
                        <div className="flex items-center w-full rounded-lg gap-6 pr-1">
                            {playingTimeArray.map((option) => (
                                <button type="button" key={option} onClick={() => setSelectedPlayingTime(option)}
                                        className={`p-2 w-full rounded-xl transition duration-300 ${selectedPlayingTime === option ? "bg-cyan-500 text-white hover:bg-cyan-600 transition duration-300" : "bg-gray-300 hover:bg-gray-400 transition duration-300"}`}>
                                    {option}
                                </button>
                            ))}
                        </div>
                    ...
                    <div>
                        <label className="font-semibold" htmlFor="niveauinterval">Niveauinterval</label>
                        <div className="flex h-12">
                    ...
                    <div>
                        <label className="font-semibold" htmlFor="kamptype">Kamptype</label>
                        <div className="flex h-12">
                            <div className="flex justify-between w-full items-center rounded-lg gap-6 pr-1">
                                {matchTypeArray.map((option) => (
                                    <button type="button" key={option} onClick={() => setSelectedMatchType(option)}
                                            className={`w-20 p-2 text-sm rounded-xl transition duration-300 ${selectedMatchType === option ? "bg-cyan-500 hover:bg-cyan-600 transition duration-300 text-white" : "bg-gray-300 hover:bg-gray-400 transition duration-300"}`}>
                                        {option}
                                    </button>
                                ))}
                            </div>
                    ...
                    <div>
                        <label className="font-semibold" htmlFor="bemærkninger">Bemærkninger</label>
                        <div className="pr-1">
                ...
                <button onClick={handleCreateMatch} className="bg-cyan-500 hover:bg-cyan-600 transition duration-300 rounded-lg py-2 px-4 text-white">
                    Opret kamp
                </button>
            </form>
        </div>
