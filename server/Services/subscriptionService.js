  ...
  try {
    ...
    const notificationScenarios = {
      REQUEST_TO_JOIN_LEVEL: {
        ...
        body: `En spiller har anmodet om at deltage.`,
        category: "makkerbors",
      ...
      INVITATION_SENT: {
        ...
        body: `Du er blevet inviteret til kamp.`,
        category: "makkerbors",
        recipients: userIds,
      },
      ...
      MATCH_FULL: {
        title: "Kamp fyldt",
        body: `Kamp er nu fyldt.`,
        category: "makkerbors",
        recipients: participantIds,
      },
      MATCH_CANCELED_DEADLINE: {
        title: "Kamp aflyst pga. frist",
        body: `Kamp er blevet aflyst på grund af fristen.`,
        category: "makkerbors",
        recipients: participantIds,
      },
      MATCH_CANCELED_BY_MATCH: {
        title: "Kamp aflyst",
        body: `Kamp er blevet aflyst af kampejer.`,
        category: "makkerbors",
        recipients: participantIds,
      },
      USER_REMOVED_FROM_MATCH: {
        title: "Bruger fjernet fra kamp",
        body: `Du er blevet fjernet fra kamp.`,
        category: "makkerbors",
        recipients: [requesterId],
      },
    };
...
const sendPrivateEventNotification = async (
  ...
  try {
    ...
    const notificationScenarios = {
      ...
      REQUEST_PROCESSED: {
        title: "Anmodning behandlet",
        body: `Din anmodning til arrangement er blevet behandlet.`,
        category: "events",
        recipients: [requesterId],
      },
      INVITATION_SENT: {
      ...
      EVENT_FULL: {
        ...
        body: `Arrangement er nu fyldt.`,
        category: "events",
        recipients: participantIds,
      },
      EVENT_CANCELED_DEADLINE: {
        title: "Arrangement aflyst pga. frist",
        body: `Arrangement er blevet aflyst på grund af fristen.`,
        category: "events",
        recipients: participantIds,
      },
      EVENT_CANCELED_BY_CREATOR: {
        title: "Arrangement aflyst",
        body: `Arrangement er blevet aflyst af arrangøren.`,
        category: "events",
        recipients: participantIds,
      },
      PLAYER_REMOVED: {
